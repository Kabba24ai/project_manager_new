                            ...
                            <div class="flex items-center space-x-4 flex-nowrap">
                                ...
                                <div class="flex items-center space-x-4 flex-nowrap">
                                    <label class="flex items-center cursor-pointer flex-shrink-0">
                                        ...
                                        />
                                        <span class="ml-2 text-sm text-gray-700 whitespace-nowrap">General</span>
                                    </label>
                                    <label class="flex items-center cursor-pointer flex-shrink-0">
                                        <input
                                            type="radio"
                                            ...
                                            class="w-4 h-4 text-blue-600 border-gray-300 focus:ring-blue-500"
                                        />
                                        <span class="ml-2 text-sm text-gray-700 whitespace-nowrap">Charge</span>
                                    </label>
                                    <label class="flex items-center cursor-pointer flex-shrink-0">
                                        <input
                                            type="radio"
                                            ...
                                            class="w-4 h-4 text-blue-600 border-gray-300 focus:ring-blue-500"
                                        />
                                        <span class="ml-2 text-sm text-gray-700 whitespace-nowrap">Refund</span>
                                    </label>
                                </div>
                            </div>
...
function taskForm() {
    return {
        ...
        orderId: '',
        customerType: 'general', // Default to 'general'
        ...
        handleServiceCallOrderSelect(order) {
            ...
            // Scroll to bottom to show customer info and Create Task button
            setTimeout(() => {
                window.scrollTo({
                    top: document.body.scrollHeight,
                    behavior: 'smooth'
        ...
        handleOrderForTaskSelect(order) {
            ...
            // Scroll to bottom to show order info and Create Task button
            setTimeout(() => {
                window.scrollTo({
                    top: document.body.scrollHeight,
                    behavior: 'smooth'
